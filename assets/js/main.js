class CalculatorHub {
    ...
    async loadCalculators() {
        try {
            ...
            // This code automatically finds your repository name from the URL.
            // It makes the script work even if you rename the repository.
            const pathSegments = window.location.pathname.split('/').filter(segment => segment);
            const repoName = pathSegments[0] || ''; // Get the first segment, which is the repo name.
            const jsonPath = repoName ? `/${repoName}/calculators.json` : '/calculators.json';
            
            console.log(`Attempting to fetch calculators from: ${jsonPath}`);
